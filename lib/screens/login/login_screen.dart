...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  static const String _assetBottomGlassBar =
      'assets/images/app/ui/carved_png_436872.png';
  static const String _assetHelpIcon =
      'assets/images/app/ui/carved_png_9727920.png';
  static const String _assetDropdownArrow =
      'assets/images/app/ui/carved_png_10968848.png';
  static const String _assetAvatarFrame =
      'assets/images/app/aeroframe_transparent.png';
  static const String _assetAvatarUser =
      'assets/images/app/default_avatar_hd.png';
  static const String _assetCheckboxOff =
      'assets/images/app/ui/carved_png_9797544.png';
  static const String _assetCheckboxOn =
      'assets/images/app/ui/carved_png_10738400.png';
  ...
  static const List<_StatusOption> _statusItems = <_StatusOption>[
    _StatusOption(
      value: 'Online',
      iconAsset: 'assets/images/app/ui/carved_png_9375216.png',
    ),
    _StatusOption(
      value: 'Busy',
      iconAsset: 'assets/images/app/ui/carved_png_9387680.png',
    ),
    _StatusOption(
      value: 'Away',
      iconAsset: 'assets/images/app/ui/carved_png_9380960.png',
    ),
    _StatusOption(
      value: 'Appear offline',
      iconAsset: 'assets/images/app/ui/carved_png_9394296.png',
    ),
  ];
  ...
  void initState() {
    super.initState();
    // Pre-fill from saved prefs only (no hardcoded credentials)
    _rememberMe = false;
  ...
  Future<void> _loadSavedPreferences() async {
    ...
    final savedPw = await secureStorage.read(key: _keySavedPw);
  ...
  Future<void> _savePreferences() async {
    ...
    if (_rememberPassword) {
      ...
      await secureStorage.delete(key: _keySavedPw);
    }
  }
  ...
  Future<void> _onSignIn() async {
    ...
    Navigator.of(
      context,
    ).push(MaterialPageRoute(builder: (_) => const ConnectingScreen()));
...
class _StatusOption {
  const _StatusOption({required this.value, required this.iconAsset});
